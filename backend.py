...
ANALYSIS_PROMPT = (
    ...
    "olmadığın her harf/kelime için bağlamdan (çevredeki kelimeler, "
    "cümlenin anlamı, dönemin yazım alışkanlıkları) en olası tahminini "
    "yap ve o kelimenin/ifadenin hemen sonuna boşluksuz bir yıldız (*) "
    "işareti koy (örn. \"...بو کلمه* ایله...\") — bu, kullanıcının hangi "
    "kelimenin gerçekten okunduğunu, hangisinin tahmin olduğunu her "
    "zaman ayırt edebilmesi içindir. Yalnızca hiçbir makul tahmin dahi "
    "yapamayacağın kadar okunaksız kısımlarda [okunamadı] kullan. Her "
    "iki durumu da (tahmin edilen kelimeler ve [okunamadı] kısımlar) "
    "ayrıca notes ve uncertain_lines alanında özetle. "

    "translit: ocr alanındaki metnin Latin harflerine harf çevirisini "
    "(transliterasyon) yaz. ocr alanında * ile işaretlediğin her tahmini "
    "kelimenin Latin karşılığını da aynı şekilde sonuna * koyarak yaz, "
    "işaretlemeyi ocr ile birebir tutarlı tut. "

    "trans: OCR metninin günümüz Türkçesi karşılığını yaz. translit/ocr "
    "alanlarında * ile işaretlenmiş (tahmin edilmiş) kelimelerin buradaki "
    "karşılığını da aynı şekilde * ile işaretle. "
