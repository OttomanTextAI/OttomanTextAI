...
ANALYSIS_PROMPT = (
    ...
    "daha açık, sade ve kolay anlaşılır biçimde yeniden yaz. Hedef kitlen "
    "bir üniversite öğrencisi veya müzede bu belgeyi okuyan sıradan bir "
    "vatandaştır; akademisyen veya uzman değildir — tek amacın kelimeyi "
    "'geçerli' bir karşılığa çevirmek değil, bu kitlenin hiç zorlanmadan "
    "anlayacağı, günlük konuşma diline yakın bir metin üretmektir. Eski "
    "veya günümüzde artık günlük dilde az kullanılan, resmî/edebî duran "
    "Osmanlıca/Arapça/Farsça kökenli kelimelerden kaçın ve bunları yaygın "
    "modern Türkçe karşılıklarıyla değiştir (örn. 'tasavvur' yerine "
    "'düşünce'/'hayal etme'; 'tebarüz etmek' yerine 'öne çıkmak'; "
    "'muhtelif' yerine 'çeşitli'/'farklı'; 'nezdinde' yerine "
    "'gözünde'/'yanında'; 'hasebiyle' yerine 'yüzünden'/'nedeniyle'; "
    "'keyfiyet' ve 'vaziyet' yerine 'durum'). Uzun, iç içe geçmiş tamlama "
    "zincirlerini (izafet yapıları) gerektiğinde kısa, doğal Türkçe "
    "cümlelere böl; uzun ve karmaşık cümleleri anlamı bozmadan sadeleştir. "
    "Anlamı ASLA değiştirme, daraltma veya atlama — amaç sadeleştirmek, "
    "yoksullaştırmak değildir. Dinî, hukukî veya tarihî bir terimin tam "
    "günlük karşılığı yoksa terimi olduğu gibi koru ve parantez içinde çok "
    "kısa bir açıklama ekle (örn. 'vakıf (dini/hayır amaçlı kurulan "
    "mülk)'). Metnin resmiyetini/ciddiyetini tamamen kaybetme — bu tarihî "
    "bir belge, günlük sohbet değildir; sade ama saygılı bir üslup "
    "kullan. Belgede bulunmayan hiçbir bilgi, yorum veya açıklama ekleme. "
    "Özel isimleri, tarihleri, yerleri ve önemli tarihî kavramları koru. "
    "trans alanındaki anlamdan sapma. Tahmin edilmiş kısımların "
    "karşılıklarını burada da **çift yıldız** içinde göster. Örnekler: "
    "'İşbu hususun tasavvur edilmesi zaruridir.' -> 'Bunun "
    "düşünülmesi/hayal edilmesi gerekir.'; 'Ahalinin nezdinde makbul bir "
    "kişi idi.' -> 'Halkın gözünde değerli bir kişiydi.'; 'Muhtelif "
    "esbaba mebni bu keyfiyet vaki olmuştur.' -> 'Çeşitli nedenlerden "
    "dolayı bu durum ortaya çıkmıştır.' "
