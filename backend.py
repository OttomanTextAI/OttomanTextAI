...
ANALYSIS_PROMPT = (
    ...
    "trans_modern alanı için: translit'teki Osmanlıca metni akıcı, doğal "
    "modern Türkçeye çevir (özet değil, çeviridir). Her cümleye karşılık "
    "bir cümle üret, sırasını koru; soru-cevap formatı varsa koru, "
    "üçüncü şahıs anlatıma çevirme. Anlamı değiştirme. Eski/edebi "
    "kelimeler yerine günlük Türkçe karşılık kullan (örn. "
    "tasavvur->düşünce, tecelli->ortaya çıkma, tebarüz etmek->öne "
    "çıkmak, muhtelif->çeşitli, nezdinde->gözünde). Günlük karşılığı "
    "olmayan tarihî/dinî terimleri koru, gerekirse parantezle kısaca "
    "açıkla. Tahmin edilen kısımları çift yıldızla işaretle. "
    ...
    "Yoksa boş liste döndür. Bu listeye yazdığın her ifade, trans_modern "
    "(Türkçe Çeviri) metninde geçtiği biçimiyle, birebir aynı yazımla "
    "olmalı — tam ad, unvan veya farklı bir yazım kullanma. Örneğin "
    "metinde 'Hazret-i Mevlana' yazıyorsa, listeye 'Mevlana Celaleddin-i "
    "Rumi' değil, 'Hazret-i Mevlana' yaz. "
    ...
    "kültürel kavramları yaz. Yoksa boş liste döndür. Bu listeye "
    "yazdığın her ifade, trans_modern (Türkçe Çeviri) metninde geçtiği "
    "biçimiyle, birebir aynı yazımla olmalı — tam ad, unvan veya farklı "
    "bir yazım kullanma. Örneğin metinde 'Hazret-i Mevlana' yazıyorsa, "
    "listeye 'Mevlana Celaleddin-i Rumi' değil, 'Hazret-i Mevlana' yaz. "
    ...
    "Bu listeye yazdığın her ifade, trans_modern (Türkçe Çeviri) "
    "metninde geçtiği biçimiyle, birebir aynı yazımla olmalı — tam ad, "
    "unvan veya farklı bir yazım kullanma. Örneğin metinde 'Hazret-i "
    "Mevlana' yazıyorsa, listeye 'Mevlana Celaleddin-i Rumi' değil, "
    "'Hazret-i Mevlana' yaz. "
